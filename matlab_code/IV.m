...
for jter = 1:length(njter)
    ...
    for i = 1:niter
        ...
        for j = 1:nrep
            ...
            [para, minimum, stat, pval] = estimate_stationary_test(abs((1+0.1/2-0.1*unifrnd(0,1))*omega0), abs((1+0.1/2-0.1*unifrnd(0,1))*alpha0),abs((1+0.1/2-0.1*unifrnd(0,1))*beta0), ser);
